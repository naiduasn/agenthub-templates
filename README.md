...
- The Google Gemini media templates are conceptually inspired by [cnemri/google-genai-skills](https://github.com/cnemri/google-genai-skills), especially the Nano Banana and Veo use skills. That repository is MIT at the time of review; AgentHub keeps original YAML and skill guidance here rather than vendoring upstream scripts.
